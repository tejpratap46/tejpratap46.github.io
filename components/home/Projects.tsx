		...
		<div className='grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4'>
			{
				projectList.map((project) => {
					...
					<div className='p-5'>
						...
						<a href={project.url} className='inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'>
							Read more
