		...
		<div className='grid h-screen-safe place-items-center'>
			<div className='w-full max-w-sm rounded-lg'>
				<div className='flex flex-col items-center p-10'>
					<Image
						className='mb-3 h-24 w-24 rounded-full shadow-lg grayscale transition duration-500 ease-in-out hover:filter-none'
						src='/images/avatar.png'
						width={240}
						height={240}
						alt='Tej Pratap Singh avatar'
						priority
						unoptimized
					/>
					...
					<div className='flex mt-4 space-x-3 md:mt-6'>
						...
						<a href='https://peerlist.io/tejpratap/resume'
							target='_blank'
							rel='noreferrer'
							className='inline-flex items-center py-2 px-4 text-sm font-medium text-center text-gray-900 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700'>
					...
					<div className='flex space-x-3'>
						...
						<a href='https://docs.google.com/document/d/1ePsXwFOMKWL7azatHPz5gNZqA5lLnndPy6we1iewMmU/export?format=pdf'
							target='_blank'
							rel='noreferrer'
							className='inline-flex items-center py-2 px-4 text-sm font-medium text-center text-gray-900 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700'>
