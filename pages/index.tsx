			...
			<Page>
				...
				<Link href='/blog'>
					<a className="block p-4 bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
						...
						<p className="font-normal text-gray-700 dark:text-gray-400">I occationally write blogs of my findings and learnings, few that is publish and keep hundreds of them in draft.</p>
					</a>
				</Link>
			</Page>
		</div>
